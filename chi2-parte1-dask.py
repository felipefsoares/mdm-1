...
def main(arquivo_csv):
    ...
    try:
        ...
        # 2. Carregar o arquivo CSV com chunks
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Processamento de dados educacionais com Dask em chunks',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog='''
Exemplos de uso:
  python chi2-parte1-dask.py ./datasets-nilo/microdados_matriculas_2023.csv
  python chi2-parte1-dask.py ./datasets-nilo/microdados_matriculas_2022.csv
        '''
    )
    ...
    parser.add_argument(
        'arquivo_csv',
        type=str,
        help='Caminho para o arquivo CSV de entrada (ex: ./datasets-nilo/microdados_matriculas_2023.csv)'
    )
    ...
    if not os.path.exists(args.arquivo_csv):
        print(f"❌ Erro: Arquivo não encontrado: {args.arquivo_csv}")
        sys.exit(1)
    
    main(args.arquivo_csv)